...
export class Detail {
  id!: string;
  isSharePopupOpen: boolean = false;
  isMoreOptionsPopupOpen: boolean = false;
  ...
  onMoreOptionsClick() {
    ...
    this.isMoreOptionsPopupOpen = true;
  }
  onCloseMoreOptionsClick(): void {
    this.isMoreOptionsPopupOpen = false;
  }
  onTrailerClick() {
